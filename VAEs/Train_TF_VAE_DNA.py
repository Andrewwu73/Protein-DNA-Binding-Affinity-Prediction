...
from generate_protein_onehot import obtainDNAData
'''
...
def train(epochs = 40, latent_dim=32, reg_coeff = 0.0001, dropout_rate = 0):
...
# train(latent_dim=32, reg_coeff=0.00005, dropout_rate=0.001)
