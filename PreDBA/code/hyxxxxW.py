...
def spiltHyxxcW(labelfile, hyddir, outdir):
    ...
    for eachlabel in fr_label:
        ...
        for eachline in fr_hyd:
            ...
            if content2 == content1:
                if oneline[2] == "F" or oneline[2] == "T" or oneline[2] == "K" or oneline[2] == "R" \
                        or oneline[2] == "H" or oneline[2] == "W":
                    content.append(str(1.0) + '\n')
                else:
                    content.append(str(0.0) + '\n')
...
if __name__ == "__main__":
    ...
    outdir = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/encode/numhxcW'
