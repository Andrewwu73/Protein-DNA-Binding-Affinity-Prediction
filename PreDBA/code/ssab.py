...
def encode_numbzd(labelfile, hyddir, outdir):
...
if __name__ == "__main__":
    ...
    outdir = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/encode/numbzd'
    encode_numbzd(labelfile, hyddir, outdir)
'''
