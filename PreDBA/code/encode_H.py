...
def encode_H_by_DSSP(dssp, AAfea_phy, outdir):
...
def encode_H_by_fasta(fasta, AAfea_phy, outdir):
    if not os.path.exists(outdir):
        os.mkdir(outdir)
...
if __name__=="__main__":
    params1 = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/DSSP/DSSP3'
    params2 = '/ifs/gdata1/yangwenyi/DATA/_Global_data/AAfea_phy.txt'
    params3 = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/encode/encode_H'
    encode_H_by_DSSP(params1, params2, params3)
    #encode_H_by_fasta(params1, params2, params3)
'''