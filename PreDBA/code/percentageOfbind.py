...
def perOfbind(binddir, chainfile, outdir):
...
if __name__ == "__main__":
    ...
    outdir = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/encode/encode_perbind'
    perOfbind(binddir, chainfile, outdir)
'''