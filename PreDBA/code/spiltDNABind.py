...
def spiltdnaBind(bindfile, chainfile, outdir):
...
if __name__ == "__main__":
    bindfile = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/cal_dnadouble_binding_sites_5.0.data'
    chainfile = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/chainDouble_D1.txt'
    outdir = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/encode/encode_dnaspbind'
