...
import numpy as np
#���Ͻ��λ��ٷֱ�
def addperpbind(featdir, chainfile, outdir,outfile):
...
if __name__ == "__main__":
    featdir = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/encode/encode_perbind'
    ...
    outfile = 'added_encode_perpbind.data'

    addperpbind(featdir, chainfile, outdir, outfile)
'''