...
# import pandas as pd
def addsumhdy1W(featdir, chainfile, outfile):
...
if __name__ == "__main__":
    ...
    outfile = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/encode/mergedfea/added_encode_sum_hyd1W.data'
    addsumhdy1(featdir, chainfile, outfile)
'''
