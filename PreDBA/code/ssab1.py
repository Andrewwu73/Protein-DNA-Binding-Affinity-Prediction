...
def encode_numalx(labelfile, hyddir, outdir):
...
if __name__ == "__main__":
    ...
    outdir = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/encode/numalx'
    encode_numalx(labelfile, hyddir, outdir)
'''
