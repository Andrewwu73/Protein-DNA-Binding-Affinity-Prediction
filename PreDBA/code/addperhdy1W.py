...
# import pandas as pd
def addperhdy1W(featdir, chainfile, outfile):
...
if __name__ == "__main__":
    ...
    outfile = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/encode/mergedfea/added_encode_per_hyd1W.data'
    addperhdy1(featdir, chainfile, outfile)
'''
