...
# import pandas as pd
def addnumbzd(featdir, chainfile, outfile):
...
if __name__ == "__main__":
    featdir = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/encode/numbzd'
    chainfile = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/chainDouble1.txt'
    outfile = '/ifs/gdata1/yangwenyi/Protein_DNANEW/Double/ClassI/encode/mergedfea/added_encode_sum_bzd.data'
    addnumbzd(featdir, chainfile, outfile)
'''